...
if(value=="jisoo"){
  ...
  const imageUrl = `https://iili.io/HU2qFbR.jpg`;
  const hoverUrl = "https://iili.io/HU2qBsI.jpg";
...
if(value=="lisa"){
  ...
  const myImage = document.getElementById("myImage");
  const imageUrl = `https://iili.io/HU2q25J.jpg`;
  const hoverUrl = "https://iili.io/HU2qBsI.jpg";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
...
if(value=="jennie"){
  ...
  const myImage = document.getElementById("myImage");
  const imageUrl = `https://iili.io/HU2q3Ov.png`;
  const hoverUrl = "https://iili.io/HU2qBsI.jpg";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
...
if(value=="rose"){
  ...
  const myImage = document.getElementById("myImage");
  const imageUrl = `https://iili.io/HU2qfxp.jpg`;
  const hoverUrl = "https://iili.io/HU2qBsI.jpg";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
